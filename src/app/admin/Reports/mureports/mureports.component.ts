...
export class MureportsComponent implements OnInit {
  ...
  onSubmitMUReport() {
    ...
    this.checkboxeventryn1(false);
    this.checkboxeventryn21(false);
    this.checkboxeventryn22(false);
    this.checkboxeventryn101(false);
    this.checkboxeventryn102(false);
    this.checkboxeventryn103(false);
  ...
  checkboxeventryn1(event) {
    this.radioy1 = event;
      this.radion1 = false;
      this.pdfradion1 = "\t";
      this.pdfradioy1 = "\t";
  }
  checkboxeventryn21(event) {
    this.radioy21 = event;
      this.radion21 = false;
      this.pdfradion21 = "\t";
      this.pdfradioy21 = "\t";
  }
  checkboxeventryn22(event) {
    this.radioy22 = event;
      this.radion22 = false;
      this.pdfradion22 = "\t";
      this.pdfradioy22 = "\t";
  }
  checkboxeventryn101(event) {
    this.radioy101 = event;
      this.radion101 = false;
      this.pdfradion101 = "\t";
      this.pdfradioy101 = "\t";
  }
  checkboxeventryn102(event) {
    this.radioy102 = event;
      this.radion102 = false;
      this.pdfradion102 = "\t";
      this.pdfradioy102= "\t";
  }
  checkboxeventryn103(event) {
